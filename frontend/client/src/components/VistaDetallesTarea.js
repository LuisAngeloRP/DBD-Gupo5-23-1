...
import { Typography, Table, TableRow, TableCell, Paper, List, ListItem, ListItemText, Grid, Dialog, DialogTitle, DialogContent } from '@mui/material';
...
const Tareas = () => {
  ...
  const handleCloseDialog = () => {
    ...
    return(
        ...
        <Typography variant="h5" style={{ fontSize: '48px', margin: '20px' }}>{nombre_proyecto}</Typography>
            <Table>
                <TableRow style={{
                        marginLeft: 20,
                        width: '100%',
                    ...
                    <TableCell style={{
                        ...
                        <TableCell style={{
                            ...
                            display: 'flex',
                            alignItems: 'center',
                        }}>Calendario</TableCell>
                </TableRow>
        </Table>
        <Paper style={{ width: 'calc(100% - 36px)', height: 'calc(100% - 190px)', padding: 18 , backgroundColor: '#ECECEC', display: 'flex' }}>
            {/* <h1>a</h1>      No sirve :v
            {true && <tareasColumna/>}
            <div>
                <h1>a</h1>
            ...
            <Grid container spacing={2}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
                    <Typography variant="h4" style={{
                            ...
                            padding: '10px',
                            textAlign: 'center',
                            }}>Tareas Pendientes</Typography>
                    <List style={{backgroundColor:'#D9D9D9', height: '100%', borderRadius: '0 0 8px 8px'}}>
                        {tareas.tareasPendientes.map((tarea, index) => (
                        <ListItem key={index}>
                            <Grid container direction="column">
                                <Grid item>
                                    <ListItemText primary={tarea.nombre_tarea} secondary={tarea.descripcion_tarea} />
                                </Grid>
                                <Grid item>
                    ...
                    <List style={{backgroundColor:'#D9D9D9', height: '100%', borderRadius: '0 0 8px 8px'}}>
                        ...
                        <ListItem key={tarea.tarea_id}>
                            <Grid container direction="column">
                                <Grid item>
                                    <ListItemText 
                                    primary={<Typography variant="h6">{tarea.nombre_tarea}</Typography>} 
                                    secondary={<Typography variant="body" component="span">{tarea.descripcion_tarea}</Typography>} />
                                </Grid>
                                <Grid item>
                                    <Typography variant="caption" component="div" style=
                                            {{display: 'flex',
                                        ...
                                        <Dialog open={openDialog === tarea.tarea_id} onClose={handleCloseDialog} PaperProps={{style: {
                                                        width: '60vw',
                                                        maxWidth: 'none',
                                                        height: '85%',
                                                        },}}>
